# Criação de funções de vários parâmetros
...
# Exemplos de funções: Fatoriais

# Vamos criar uma função e chamaremos ela de factorial_function
...
# Uma função pode chamar outras funções, ou até mesmo ela mesma. Quando uma função se chama, essa situação é conhecida como recursão

# Você pode usar funções recursivas no Python para escrever um código limpo e elegante e dividi-lo em pedaços menores e organizados.
